...
``` {r installation, echo = FALSE, message = FALSE,results = "hide"}
devtools::install_github("anirban0451/tpidesigns", INSTALL_opts=c("--no-multiarch"))
```
``` {r installation-show, echo = TRUE, eval = FALSE}
